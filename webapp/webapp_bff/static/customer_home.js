 ...
 * chat.js의 compact 모드(sentPromptId/resultId)가 보낸 문구와 결과를 알아서
 * sent-prompt/compact-result로 그려주므로, 여기서는 렌더링을 직접 하지
 * 않는다 — 옆의 바로가기 버튼만 방금 고른 액션에 맞는 정식 화면으로
 * 목적지를 바꾼다.
 */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  initChatWidget({
    ...
    sentPromptId: "customer-quick-sent",
    resultId: "customer-quick-result",
    profile: "coordinator",
